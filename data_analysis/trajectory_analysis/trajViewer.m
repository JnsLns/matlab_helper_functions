...
%
% Inspect individual trajectory data from mouse tracking scripts. Circular
% markers indicate 100 ms steps. Items are plotted as circles with the item
% radius stored in the data (or, if that is not available, using a default
% radius).
%
% ___Example___
%
