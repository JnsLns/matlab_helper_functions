function [outputCurve,arcSpanned] = interpToUniformSegments(x,y,segLen,excessHandling,symThresh,symTimeThresh,roundToDec)
% outputCurve = interpToUniformSegments(x,y,segLen,excessHandling,symThresh,symTimeThresh,roundToDec)
%
